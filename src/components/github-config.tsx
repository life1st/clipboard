          ...
          {isConfigured && (
            <div className="config-preview">
              <p className="token-preview">
                <span>Token:</span> <span>{githubToken.substring(0, 8)}{Array(10).fill('*').join('')}{githubToken.substring(githubToken.length - 6)}</span>
              </p>
              <p className="gist-preview">
                <span>Gist:</span> <span>{gistId}</span>
              </p>
            </div>
          )}
        </div>
